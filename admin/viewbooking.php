            ...
            <?php
                ...
                if($len>0)
                {
                    ...
                    for($i=0;$i<$len;$i++)
                    {
                        ...
                        $status=urlencode($booking_array[$i]["status"]);
                        ...
                        if($status!='Delivered')
                            echo "<td><a href=updatestatusform.php?bookingid=$bid&status=$status>".$booking_array[$i]["bookingid"]."</td>";
                        else
