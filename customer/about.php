...
<head>
    ...
    <link href="Template/Template/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="Template/Template/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid" src="Template/Template/img/about.jpg" alt="">
                </div>
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h5 class="font-weight-medium font-arial mb-4">Our 360-degree cleaning methodology promises the supreme cleaning process at the most competitive pricing ever.</h5>
                    <p class="mb-2"> Our fast-paced dry cleaning processing unit includes the best quality Hydrocarbon solution technology, an experienced workforce, and the best-in-class steam pressing with an effective application of moisture, heat, and pressure for the perfect crease. Make your first impression look admirable after slipping into your clothes done up at LAUNDRY.</p>
                    <div class="row">
   ...
   <!-- <div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
    ...
    <script src="Template/Template/lib/easing/easing.min.js"></script>
    <script src="Template/Template/lib/waypoints/waypoints.min.js"></script>
    <script src="Template/Template/lib/counterup/counterup.min.js"></script>
    <script src="Template/Template/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="Template/Template/mail/jqBootstrapValidation.min.js"></script>
    <script src="Template/Template/mail/contact.js"></script>
